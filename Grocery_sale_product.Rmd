...
ນຳເອົາຂໍ້ມູນສິນຄ້າ50ລາຍການທີ່ໄດ້ຂາຍມາສະແດງ
...
ເອົາຂໍ້ມູນສິນຄ້າທີ່ໄດ້ຮັບຄວາມນິຍົມມາຈດເປັນ 10  ອັນດັບທຳອິດ
...
ລວມຈຳນວນສິນຄ້າທີ່ໄດ້ຂາຍໃນແຕ່ລະມື້ ແລ້ວນຳຂໍ້ມູນມາສະແດງໃຫ້ເຫັນເປັນກຣາຟ
```{r}
...
ລວມຈຳນວນສິນຄ້າທີ່ໄດ້ຂາຍໃນແຕ່ລະເດືອນ ແລ້ວນຳຂໍ້ມູນມາສະແດງໃຫ້ເຫັນເປັນກຣາຟ
```{r}
...
ດຶງເອົາຂໍ້ມູນສິນຄ້າທີ່ໄດ້ຂາຍດີທີ່ສຸດ 10 ອັນດັບທຳອິດມາສະແດງເປັນຈຳນວນທີ່ໄດ້ຂາຍໃນແຕ່ລະວັນທິດຫາວັນເສົາ
````{r}
...
ດຶງເອົາຂໍ້ມູນສິນຄ້າທີ່ໄດ້ຂາຍດີທີ່ສຸດມາສະແດງເປັນຈຳນວນທີ່ໄດ້ຂາຍໃນແຕ່ລະເດືອນ
````{r}
...
meat <- grocery[grocery$item == "meat",-c(1,2,3,6)]
...
ການວິເຄາະຂອງສິນຄ້າໃນແຕ່ລະເດືອນ
````{r}
ggplot(data = wide, aes(x = month)) +
